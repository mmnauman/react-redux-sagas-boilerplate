...
### jest-setup js - 
This is the file where we declare adapter that are useful in terms of unit testing code also we can add here few other jest configuration parameters.
### jsconfig json - 
The jsconfig json consist of declaration for absolute routing, the paths here must be predefined and other javascript configurations can be added here.
### package json - 
